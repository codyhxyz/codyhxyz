...
*why a lemon? on twitter I'm known as [lemonaut](https://twitter.com/lemonautzest).*
...
- **most user interfaces are poor cognitive ergonomics**: most UIs til now have been shallow facsimiles of the world models our brains generate about the very same UIs; we would do well to introspect and more closely model how our brains see software systems, rethinking UI paradigms from first principles and redesigning them to be more ideal cognitive ergonomics. For example: internet browser tabs, and the 'windows' GUI paradigm, need to be thrown out. New layers of abstraction are coming.
...
<sub>*"i create because i envision that there are people out there who need the lemon zest."*</sub>
